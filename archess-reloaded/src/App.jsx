...
import PlayerPanels from './components/PlayerPanels/PlayerPanels'
...
function App() {
    ...
    const {updateSubscriber} = React.useContext(SubscriptionContext);
    ...
    React.useEffect(() => {
        ...
        const startGame = async (res) => {
            ...
            if (res.opponentSid) {
                ...
                game.set(p => {
                    let outp = {...p};
                    outp.opponent.sid = res.opponentSid;
                    return outp;
                });
                // console.log(opp);
                updateSubscriber(res.opponentSid, res.opponentId);
            }
